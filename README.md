...
### Step 4:
After installing go back to python idle file location and go to ```Lib``` (just above ```Scripts```) after  going follow this path:<br>
...
### Step 7:
Run the program and a frame will open in which :<br>
...
## Output:
![Emotion Recognition Output](Output.png)
## Result:
